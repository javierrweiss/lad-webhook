...
# LABEL net.clojars.sanatoriocolegiales.sanatoriocolegiales.lad-webhook="sanatoriocolegiales lad-webhook service"
# LABEL io.github.practicalli.team="Practicalli Engineering Team"
# LABEL version="0.1.0-SNAPSHOT"
# LABEL description="sanatoriocolegiales lad-webhook service"
...
WORKDIR /service
COPY --from=builder /build/target/sanatoriocolegiales-lad-webhook-standalone.jar /service/
...
CMD ["java", "-jar", "/service/sanatoriocolegiales-lad-webhook-standalone.jar"]
